/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 5b0028fac11e9e44b81b2a2e44bc6300)
// Runtime types generated with workerd@1.20260701.1 2025-06-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	...
	NEXT_PUBLIC_APPWRITE_USER_COLLECTION: string;
	NEXT_PUBLIC_APPWRITE_FILE_COLLECTION: string;
	NEXT_PUBLIC_APPWRITE_FILE_STORAGE_COLLECTION: string;
	NEXT_PUBLIC_APPWRITE_BUCKET: string;
	NEXT_APPWRITE_SECRET_KEY: string;
	WORKER_SELF_REFERENCE: Fetcher /* storage-app */;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "NEXT_PUBLIC_APPWRITE_PROJECT_ID" | "NEXT_PUBLIC_APPWRITE_PROJECT_NAME" | "NEXT_PUBLIC_APPWRITE_ENDPOINT" | "NEXT_PUBLIC_APPWRITE_DATABASE" | "NEXT_PUBLIC_APPWRITE_USER_COLLECTION" | "NEXT_PUBLIC_APPWRITE_FILE_COLLECTION" | "NEXT_PUBLIC_APPWRITE_FILE_STORAGE_COLLECTION" | "NEXT_PUBLIC_APPWRITE_BUCKET" | "NEXT_APPWRITE_SECRET_KEY">> {}
}
